...
\includegraphics[width=0.37\linewidth]{kde.png}
%\includegraphics[width=0.3\linewidth]{palette_generation}
\includegraphics[width=0.32\linewidth]{scatter.png}
...
\begin{textblock*}{0.9\paperwidth}(0.05\paperwidth,0.45\paperheight)
	\centering
	\includegraphics<1>[width = 0.5\textwidth]{dnn.png}
	\includegraphics<2>[width = 0.7\textwidth]{google_net.png}
	\includegraphics<2>[width = 0.2\textwidth]{more_layers.png}
\end{textblock*}

\begin{textblock*}{0.9\paperwidth}(0.05\paperwidth,0.62\paperheight)
	\centering
\includegraphics<3>[width = 0.3\textwidth]{visual_stream.png}
\end{textblock*}
...
\centering
\includegraphics[width=0.85\linewidth]{network_zoo_poster_1.png}
...
%\includegraphics[width=0.15\linewidth]{network_zoo_poster_leg.png}
\includegraphics[width=0.85\linewidth]{network_zoo_poster_3.png}
